...
`svgo -r -f tnaomegauiprototypes/static_src/images`
...
`svgo tnaomegauiprototypes/static_src/images/[your-file.svg] -o ./tnaomegauiprototypes/static_src/optimised_images`
...
`imagemin tnaomegauiprototypes/static_src/images/\*.{jpg,jpeg} --plugin=mozjpeg --out-dir=./tnaomegauiprototypes/static_src/images`
...
`imagemin tnaomegauiprototypes/static_src/images/[your-file.jpg] --plugin=mozjpeg --out-dir=./tnaomegauiprototypes/static_src/optimised_images`
