...
from tnaomegauiprototypes.search import views as search_views
from tnaomegauiprototypes.utils.cache import get_default_cache_control_decorator
...
if getattr(settings, "PATTERN_LIBRARY_ENABLED", False) and apps.is_installed(
    ...
    from tnaomegauiprototypes.project_styleguide.views import example_form
...
# Error handlers
handler404 = "tnaomegauiprototypes.utils.views.page_not_found"
handler500 = "tnaomegauiprototypes.utils.views.server_error"
