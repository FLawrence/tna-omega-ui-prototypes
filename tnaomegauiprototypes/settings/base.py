"""
Django settings for tnaomegauiprototypes project.
"""
import os
import sys
...
INSTALLED_APPS = [
    ...
    #  * SCOUT_NAME="tnaomegauiprototypes"
    ...
    "scout_apm.django",
    "tnaomegauiprototypes.documents",
    "tnaomegauiprototypes.forms",
    "tnaomegauiprototypes.home",
    "tnaomegauiprototypes.images",
    "tnaomegauiprototypes.navigation",
    "tnaomegauiprototypes.search",
    "tnaomegauiprototypes.users",
    "tnaomegauiprototypes.utils",
    ...
    "pattern_library",
    "tnaomegauiprototypes.project_styleguide.apps.ProjectStyleguideConfig",
...
ROOT_URLCONF = "tnaomegauiprototypes.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "tnaomegauiprototypes.utils.context_processors.global_vars",
            ],
...
WSGI_APPLICATION = "tnaomegauiprototypes.wsgi.application"
...
DATABASES = {
    "default": dj_database_url.config(
        conn_max_age=600, default="postgres:///tnaomegauiprototypes"
    )
}
...
WAGTAIL_SITE_NAME = "tna-prototype"
